...
=======
*@brief This pass replaces S found adjecent with Pauli gate with S
     dagger *gate.If S is adjecent with Z gate,
    Z is reduced.* / class QirSToSDaggerPass : public PassModule {
public:
  /**
   * @brief Applies this pass to the QIR's LLVM module.
   *
