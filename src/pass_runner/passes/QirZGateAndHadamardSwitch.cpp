...
=======
 * @brief Implementation of the 'QirZGateAndHadamardSwitchPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirZGateAndHadamardSwitch.cpp?ref_type=heads">Go to the source code of this file.</a>
...
<<<<<<< HEAD
PreservedAnalyses
QirZGateAndHadamardSwitchPass::run(Module &module,
...
=======
PreservedAnalyses QirZGateAndHadamardSwitchPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
    auto& Context = module.getContext();
...
/**
 * @brief External function for loading the 'QirZGateAndHadamardSwitchPass' as a 'PassModule'.
 * @return QirZGateAndHadamardSwitchPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirZGateAndHadamardSwitchPass();
