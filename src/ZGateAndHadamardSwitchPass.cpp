...
namespace {
  class ZGateAndHadamardSwitchPass
      : public PassWrapper<ZGateAndHadamardSwitchPass, OperationPass<func::FuncOp>> {
  public:
    ...
    llvm::StringRef getDescription() const override { return "Pass that switches a pattern composed by Z and Hadamard to Hadamard and X";}
  
    void runOnOperation() override {
      auto circuit = getOperation();
      circuit.walk([&](Operation *op){
        mqss::utils::patternSwitch<quake::ZOp,quake::HOp,quake::XOp>(op);
      });
    }
  };
} // namespace
