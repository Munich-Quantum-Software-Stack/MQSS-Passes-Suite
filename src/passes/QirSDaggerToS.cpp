 ...
 * @brief Implementation of the 'QirSDaggerToSPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirSDaggerToS.cpp?ref_type=heads">Go to the source code of this file.</a>
 *
 */
 ...
 */
PreservedAnalyses QirSDaggerToSPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
    auto& Context = module.getContext();
    std::unordered_set<std::string> pauliGates = {"__quantum__qis__x__body", "__quantum__qis__y__body", "__quantum__qis__z__body"};    
    ...
    for (auto &function : module) {
        ...
        while (!gatesToReplace.empty()) {
            ...
            Function *newFunction = module.getFunction("__quantum__qis__s__body");
            if (!newFunction) {
...
/**
 * @brief External function for loading the 'QirSDaggerToSPass' as a 'PassModule'.
 * @return QirSDaggerToSPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirSDaggerToSPass();
}
