 ...
 * @brief Implementation of the 'QirCommuteCnotZPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirCommuteCnotZ.cpp?ref_type=heads">Go to the source code of this file.</a>
 *
 */
 ...
 */
PreservedAnalyses QirCommuteCnotZPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
...
/**
 * @brief External function for loading the 'QirCommuteCnotZPass' as a 'PassModule'.
 * @return QirCommuteCnotZPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirCommuteCnotZPass();
}
