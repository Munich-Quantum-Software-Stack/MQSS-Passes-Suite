...
public:
  ...
  llvm::StringRef getArgument() const override { return "commute-zcnot-pass"; }
  llvm::StringRef getDescription() const override { return "Apply commutation pass of the pattern Z-CNot to CNot-Z";}

  void runOnOperation() override {
    auto circuit = getOperation();
    circuit.walk([&](Operation *op){
      mqss::utils::commuteOperation<quake::ZOp, quake::XOp>(op,0,1,1,1);
      //CommuteZCNot(op);
    });
  }
};
