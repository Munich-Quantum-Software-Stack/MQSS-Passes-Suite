...
=======
 * @brief Implementation of the 'QirHadamardAndXGateSwitchPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirHadamardAndXGateSwitch.cpp?ref_type=heads">Go to the source code of this file.</a>
...
=======
PreservedAnalyses QirHadamardAndXGateSwitchPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
    auto& Context = module.getContext();
...
/**
 * @brief External function for loading the 'QirHadamardAndXGateSwitchPass' as a 'PassModule'.
 * @return QirHadamardAndXGateSwitchPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirHadamardAndXGateSwitchPass();
