 ...
 * @brief Implementation of the 'QirSToSDaggerPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirSToSDagger.cpp?ref_type=heads">Go to the source code of this file.</a>
 *
 */
 ...
 */
PreservedAnalyses QirSToSDaggerPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
...
/**
 * @brief External function for loading the 'QirSToSDaggerPass' as a 'PassModule'.
 * @return QirSToSDaggerPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirSToSDaggerPass();
}
