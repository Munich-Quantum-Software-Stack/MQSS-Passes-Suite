 ...
 * @brief QUAKE MLIR pass that decomposes two qubits CNot (XOp).
 ...
 XOp operation in a given QUAKE MLIR module and performs its replacement by a
 ...
 * @brief QUAKE MLIR pass that decomposes two qubits ZOp.
 ...
 ZOp operation in a given QUAKE MLIR module and performs its replacement by a
...
/**
 * @brief QUAKE MLIR pass that operates on each CNot gate in a given quantum
 circuit.
 ...
 controls by introducing additional Hadamard gates, in a given QUAKE MLIR
 module, as follows.
...
/**
 * @brief QUAKE MLIR pass that operates on the pattern composed of S and
