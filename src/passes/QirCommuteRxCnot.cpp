 ...
 */
PreservedAnalyses QirCommuteRxCnotPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
...
/**
 * @brief External function for loading the 'QirCommuteRxCnotPass' as a 'PassModule'.
