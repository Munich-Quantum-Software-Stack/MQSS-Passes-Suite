 ...
 * @brief Implementation of the 'QirU3ToRzRyRzDecompositionPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirU3Decomposition.cpp?ref_type=heads">Go to the source code of this file.</a>
 *
 ...
 */
PreservedAnalyses QirU3ToRzRyRzDecompositionPass::run(Module &module, ModuleAnalysisManager &MAM) {
    ...
    function = Function::Create(
        ...
        "__quantum__qis__U3_to_rzryrz__body",
        module
    );
    ...
    Function *functionValue = module.getFunction("__quantum__qis__U3_to_rzryrz__body");
    if (functionValue) {
...
/**
 * @brief External function for loading the 'QirU3ToRzRyRzDecompositionPass' as a 'PassModule'.
