 ...
 * @brief Implementation of the 'QirCommuteXCnotPass' class. <a href="https://gitlab-int.srv.lrz.de/lrz-qct-qis/quantum_intermediate_representation/qir_passes/-/blob/Plugins/src/passes/QirCommuteXCnot.cpp?ref_type=heads">Go to the source code of this file.</a>
 *
 */
 ...
 */
PreservedAnalyses QirCommuteXCnotPass::run(Module &module, ModuleAnalysisManager &/*MAM*/) {
...
/**
 * @brief External function for loading the 'QirCommuteXCnotPass' as a 'PassModule'.
 * @return QirCommuteXCnotPass
 */
extern "C" PassModule* loadQirPass() {
    return new QirCommuteXCnotPass();
}
